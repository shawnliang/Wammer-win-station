...
{
	partial class FirstUseWizardDialog
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FirstUseWizardDialog));
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(535, 369);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(454, 369);
			...
			this.Name = "FirstUseWizardDialog";
			this.Text = "First use wizard";
