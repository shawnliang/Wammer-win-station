	...
	public class AddDriverHandler: HttpHandler
	{
		...
		public override void HandleRequest()
		{
			if (Parameters[CloudServer.PARAM_SESSION_TOKEN] != null && Parameters[CloudServer.PARAM_USER_ID] != null)
			{
				...
				RespondSuccess(m_DriverAgent.AddDriver(Station.Instance.ResourceBasePath, Station.Instance.StationID, userID, sessionToken));
			}
			else
			{
				...
				RespondSuccess(m_DriverAgent.AddDriver(Station.Instance.ResourceBasePath, Station.Instance.StationID, email, password, deviceId, deviceName));
			}
		}
		#endregion
