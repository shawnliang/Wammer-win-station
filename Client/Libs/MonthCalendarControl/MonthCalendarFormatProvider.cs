namespace CustomControls
{
   ...
   public class MonthCalendarFormatProvider : ICustomFormatProvider
   {
      ...
      /// <summary>
      /// Prevents a default instance of the <see cref="MonthCalendarFormatProvider"/> class from being created.
      /// </summary>
      private MonthCalendarFormatProvider()
      { }
      ...
      public virtual string[] MonthNames
      {
         ...
         set
         {
            ...
            {
               if (string.IsNullOrEmpty(value[i]) && i != 13)
               {
                  return;
               }
            }
      ...
      {
         this.CheckMonthAndYear(year, month);
      ...
      public virtual void CheckMonthAndYear(int year, int month)
      {
         ...
         if (!validYear)
         {
            throw new InvalidOperationException("Parameter 'year' is out of bounds.");
         }

         if (month < 1 || month > 13)
         {
            throw new InvalidOperationException("Parameter 'month' is out of bounds.");
         }
      }
      ...
      {
         if (source == null || custom == null || source.Length != custom.Length)
         {
            return true;
         }
