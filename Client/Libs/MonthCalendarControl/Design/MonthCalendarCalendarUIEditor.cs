...
namespace CustomControls.Design
{
   ...
   internal class MonthCalendarCalendarUIEditor : UITypeEditor
   {
      ...
      private class CalendarItem
      {
         ...
         public CalendarItem(Calendar cal, bool isCultureCalendar)
         {
         ...
         public override string ToString()
         {
            if (this.Item != null)
            {
               ...
               return this.Item.ToString().Replace("System.Globalization.", "").Replace("Calendar", "") + addString;
            }
