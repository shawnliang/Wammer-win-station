namespace CustomControls.Design
{
   ...
   internal class MonthCalendarControlDesigner : ControlDesigner
   {
      ...
      internal class MonthCalendarControlDesignerActionList : DesignerActionList
      {
         ...
         /// </summary>
         private CustomControls.MonthCalendar cal;

         /// <summary>
         /// The <see cref="IComponentChangeService"/>.
         /// </summary>
         private IComponentChangeService iccs;

         /// <summary>
         /// The <see cref="DesignerActionUIService"/>.
         /// </summary>
         private DesignerActionUIService designerUISvc;
         ...
         internal void SaveColorTable()
         {
            ...
            // create save dialog
            using (SaveFileDialog dlg = new SaveFileDialog { Filter = "XML File (*.xml)|*.xml" })
            {
               // show dialog
         ...
         internal void LoadColorTable()
         {
            ...
            using (OpenFileDialog dlg = new OpenFileDialog { Filter = "XML File (*.xml)|*.xml" })
            {
               // show dialog
               if (dlg.ShowDialog() == DialogResult.OK)
               {
