namespace CustomControls
{
   ...
   internal class MonthCalendarDate : ICloneable
   {
      ...
      /// <summary>
      /// Prevents a default instance of the <see cref="MonthCalendarDate"/> class from being created.
      /// </summary>
      private MonthCalendarDate()
      {
      }
      ...
      public MonthCalendarDate GetFirstDayInWeek(ICustomFormatProvider provider)
      {
         ...
         MonthCalendarDate dt = this.Clone() as MonthCalendarDate;
      ...
      {
         return this.ToString(format, fp, null);
      }
      ...
      /// <returns>A string representation of this object.</returns>
      public string ToString(string format, IFormatProvider fp, ICustomFormatProvider nameProvider)
      {
         if (fp != null)
         {
            ...
            if (dtfi != null)
            {
               return this.ToString(format, dtfi, nameProvider);
            }
         }

         return this.ToString(format, null, nameProvider);
      }
