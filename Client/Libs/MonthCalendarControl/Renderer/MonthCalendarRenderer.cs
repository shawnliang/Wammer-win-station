namespace CustomControls
{
    ...
    public class MonthCalendarRenderer : MonthCalendarAbstractRenderer
    {
        ...
        /// </summary>
        private MonthCalendar monthCal;
           ...
           MonthCalendarHeaderState state)
        {
            ...
            if (firstVisible.Era != date.Era)
            {
                ...
                year = firstVisible.Year.ToString();
            }
            else
            {
            ...
            SizeF yearSize = g.MeasureString(year, boldFont);
            ...
            Point[] arrowRight = new[]
         {
               ...
               brushSelected = new SolidBrush(colorTable.HeaderSelectedText))
            {
                ...
                g.DrawString(year, yearFont, yearBrush, yearRect);
            }
            ...
            using (StringFormat format = GetStringAlignment(this.monthCal.DayTextAlignment))
            {
                ...
                using (SolidBrush brush = new SolidBrush(textColor))
                {
                       ...
                       FontStyle.Bold))
                    {
                        ...
                        //string dayString = day.Date.Day.ToString();
                        string dayString = new MonthCalendarDate(monthCal.CultureCalendar, day.Date).Day.ToString();
        ...
        public override void DrawFooter(Graphics g, Rectangle rect, bool active)
        {
            ...
            string dateString = new MonthCalendarDate(this.monthCal.CultureCalendar, DateTime.Today).ToString(null, null, this.monthCal.FormatProvider);
            ...
            // draw date string
            using (StringFormat format = GetStringAlignment(ContentAlignment.MiddleLeft))
            {
                if (this.monthCal.UseRTL)
                {
