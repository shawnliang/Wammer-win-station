namespace CustomControls
{
   ...
   internal class DatePickerDateTextBox : Control
   {
      ...
      /// </summary>
      private InputDateTextBox inputBox;
      ...
      protected override bool ProcessDialogKey(Keys keyData)
      {
         ...
         {
            this.SetDatePart(keyData == Keys.Left);
      ...
      protected override void OnKeyPress(KeyPressEventArgs e)
      {
         ...
         if (!this.inEditMode)
         {
            ...
            this.inputBox.Text = e.KeyChar.ToString();
      ...
      protected override void OnPaint(PaintEventArgs e)
      {
         ...
         using (StringFormat format = new StringFormat(StringFormatFlags.LineLimit | StringFormatFlags.NoClip | StringFormatFlags.NoWrap))
         {
               ...
               selectedBack = new SolidBrush(SystemColors.Highlight))
            {
               ...
               string dateString = parser.ParsePattern(date);
      ...
      private void InputBoxFinishedEditing(object sender, EventArgs e)
      {
         ...
         string inputStr = this.inputBox.Text;
         int stringLength = inputStr.Length;

         if (stringLength == 6 || stringLength == 8)
         {
            int yearLength = stringLength == 8 ? 4 : 2;

            string dayString = inputStr.Substring(this.dayPartIndex * 2, 2);
            string monthString = inputStr.Substring(this.monthPartIndex * 2, 2);
            string yearString = inputStr.Substring(this.yearPartIndex * 2, yearLength);
      ...
      private class InputDateTextBox : TextBox
      {
         ...
         protected override bool ProcessDialogKey(Keys keyData)
         {
            if (keyData == Keys.Enter || keyData == Keys.Tab || keyData == Keys.Escape)
            {
               ...
               if (this.FinishedEditing != null)
               {
                  this.FinishedEditing(this, EventArgs.Empty);
               }
         ...
         protected override void OnKeyPress(KeyPressEventArgs e)
         {
            if ((!char.IsNumber(e.KeyChar) || this.Text.Length == 8) && e.KeyChar != '\b')
            {
               e.Handled = true;
      ...
      private class DatePatternParser
      {
         ...
         private ICustomFormatProvider provider;
         ...
         /// <summary>
         /// Prevents a default instance of the <see cref="DatePatternParser"/> class from being created.
         /// </summary>
