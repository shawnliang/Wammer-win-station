...
namespace Waveface.DetailUI
{
    partial class PhotoView
    {
        ...
        private void InitializeComponent()
        {
			...
			this.toolTip.SetToolTip(this.thumbnailNavigator1, resources.GetString("thumbnailNavigator1.ToolTip"));
			// 
			// panelBottom
			// 
			...
			this.toolTip.SetToolTip(this.panelBottom, resources.GetString("panelBottom.ToolTip"));
			// 
			// pnlPhotoViewToolBar
			// 
			...
			this.toolTip.SetToolTip(this.pnlPhotoViewToolBar, resources.GetString("pnlPhotoViewToolBar.ToolTip"));
			// 
			// cultureManager
			// 
			...
			this.toolTip.SetToolTip(this.imageBox, resources.GetString("imageBox.ToolTip"));
