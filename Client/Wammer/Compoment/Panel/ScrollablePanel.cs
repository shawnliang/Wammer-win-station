...
namespace Waveface.Compoment
{
    public class ScrollablePanel : Panel
    {
        ...
        private int autoScrollHorizontalMinimum;
        private int autoScrollHorizontalMaximum = 100;

        private int autoScrollVerticalMinimum;
        ...
        public int AutoScrollVerticalMinimum
        {
            ...
            set
            {
                ...
                SetScrollRange(Handle, (int) SB_VERT, autoScrollHorizontalMinimum, autoScrollHorizontalMaximum, true);
            }
        }
            ...
            switch (msg.Msg)
            {
                case WM_MOUSEWHEEL:
                    ...
                    try
                    {
                        ...
                        {
                            case MK_LBUTTON:
                                butt = MouseButtons.Left;
                                break;
                            case MK_MBUTTON:
                                butt = MouseButtons.Middle;
                                break;
                            case MK_RBUTTON:
                                butt = MouseButtons.Right;
                                break;
                            case MK_XBUTTON1:
                                butt = MouseButtons.XButton1;
                                break;
                            case MK_XBUTTON2:
                                butt = MouseButtons.XButton2;
                                break;
                            default:
                                butt = MouseButtons.None;
                                break;
                        }
                        MouseEventArgs arg0 = new MouseEventArgs(butt, 1, x, y, zDelta);
                ...
                case WM_VSCROLL:
                    ...
                    try
                    {
                        ...
                        ScrollEventArgs arg = new ScrollEventArgs(type, GetScrollPos(Handle, (int) SB_VERT));
                ...
                case WM_HSCROLL:
                    ...
                    {
                        ScrollEventType type = getScrollEventType(msg.WParam);
                        ScrollEventArgs arg = new ScrollEventArgs(type, GetScrollPos(Handle, (int) SB_HORZ));
        ...
        public void performScrollHorizontal(ScrollEventType type)
        {
            ...
            if (param == -1)
                return;
            SendMessage(Handle, WM_HSCROLL, (UIntPtr) param, (IntPtr) 0);
        }
        ...
        public void performScrollVertical(ScrollEventType type)
        {
            ...
            if (param == -1)
                return;
            SendMessage(Handle, WM_VSCROLL, (UIntPtr) param, (IntPtr) 0);
        }
