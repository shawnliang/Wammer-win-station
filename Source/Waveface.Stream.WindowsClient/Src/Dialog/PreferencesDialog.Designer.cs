namespace Waveface.Stream.WindowsClient
{
	partial class PreferencesDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.pbxDevice = new System.Windows.Forms.PictureBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.pbxDevice)).BeginInit();
			...
			this.panelEx1.Controls.Add(this.pbxDevice);
			...
			// pbxDevice
			// 
			this.pbxDevice.BackColor = System.Drawing.Color.Transparent;
			this.errorProvider1.SetIconAlignment(this.pbxDevice, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("pbxDevice.IconAlignment"))));
			this.pbxDevice.Image = global::Waveface.Stream.WindowsClient.Properties.Resources.winControl2;
			resources.ApplyResources(this.pbxDevice, "pbxDevice");
			this.pbxDevice.Name = "pbxDevice";
			this.pbxDevice.TabStop = false;
			// 
			// label2
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.pbxDevice)).EndInit();
		...
		private System.Windows.Forms.PictureBox pbxDevice;
	}
}