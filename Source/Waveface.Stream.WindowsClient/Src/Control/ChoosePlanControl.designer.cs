namespace Waveface.Stream.WindowsClient
{
	partial class ChoosePlanControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioFree.Location = new System.Drawing.Point(21, 89);
			...
			this.radio250.Location = new System.Drawing.Point(21, 175);
			...
			this.radio500.Location = new System.Drawing.Point(21, 264);
			...
			this.label3.Text = "Save all original files to one PC";
			// 
			// label4
			// 
			...
			this.label4.Text = "250GB cloud storage, plus multiple PC storage management";
			// 
			// label5
			// 
			...
			this.label5.Text = "$4.99 USD/month";
			// 
			// label7
			// 
			...
			this.label7.Text = "$7.99 USD/month";
			// 
			// label6
			// 
			...
			this.label6.Text = "250GB cloud storage, plus multiple PC storage management";
			// 
			// pictureBox1
			// 
			this.pictureBox1.Image = global::Waveface.Stream.WindowsClient.Properties.Resources.PersonalCloud;
			this.pictureBox1.Location = new System.Drawing.Point(387, 72);
			...
			this.linkLabel1.Location = new System.Drawing.Point(18, 315);
			...
			this.Size = new System.Drawing.Size(704, 356);
