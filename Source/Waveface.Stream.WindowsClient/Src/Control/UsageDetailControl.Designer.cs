namespace Waveface.Stream.WindowsClient.Src.Control
{
	partial class UsageDetailControl
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UsageDetailControl));
			...
			// lblLocalDocument
			// 
			resources.ApplyResources(this.lblLocalDocument, "lblLocalDocument");
			...
			// lblLocalWeb
			// 
			resources.ApplyResources(this.lblLocalWeb, "lblLocalWeb");
			...
			// lblLocalPhoto
			// 
			resources.ApplyResources(this.lblLocalPhoto, "lblLocalPhoto");
			...
			// 
			resources.ApplyResources(this.btnChangeResourceFolder, "btnChangeResourceFolder");
			...
			// lblCloudTotalUsage
			// 
			resources.ApplyResources(this.lblCloudTotalUsage, "lblCloudTotalUsage");
